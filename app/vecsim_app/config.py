...
REDIS_URL_DEFAULT = f"redis://:{REDIS_PASSWORD}@{REDIS_HOST}:{REDIS_PORT}/{REDIS_DB}"
REDIS_DATA_URL = os.environ.get("REDIS_DATA_URL", REDIS_URL_DEFAULT)
REDIS_OM_URL = os.environ.get("REDIS_DATA_URL", REDIS_URL_DEFAULT)
API_V1_STR = "/api/v1"
